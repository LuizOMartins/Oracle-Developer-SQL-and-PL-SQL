...
--DROP TABLE CIDADES;
-- TABELA CIDADES COM REFERENCIA AO COD_UF DA TABELA UF PARA SABER DE QUAL ESTADO E A CIDADE
...
-- chave estrangeira de Clientes para COD_empresa e COD_Cidade
-- para saber a empresa que é o Cliente e a Cidade
...
CREATE TABLE MATERIAL ( --  Material com chave estrangeira para tipo de material 
    COD_EMPRESA INT NOT NULL,
...
CREATE TABLE MAT_FORNEC( -- FORNECEDOR DE MATERIAIS
    COD_EMPRESA INT NOT NULL,
    COD_MAT INT NOT NULL,
    ID_FOR INT NOT NULL,
...
CREATE TABLE ORDEM_PROD ( 
    -- ORDEM DE PRODUTOS: CRIAÇÃO DE PRODUTOS
    COD_EMPRESA INT NOT NULL,
...
--DROP TABLE CONSUMO -- mostrat o historico de consumo para de um material para determinado apontamento
